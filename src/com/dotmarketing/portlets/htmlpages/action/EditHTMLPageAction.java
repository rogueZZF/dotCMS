...
public class EditHTMLPageAction extends DotPortletAction implements DotPortletActionInterface {
	...
	public void _editWebAsset(ActionRequest req, ActionResponse res, PortletConfig config, ActionForm form, User user) throws Exception {
		...
		ActivityLogger.logInfo(this.getClass(), "editing HTMLpage action", "User " + user.getUserId() + " editing page" + hf.getTitle(), HostUtil.hostNameUtil(req, _getUser(req)));
	...
	public void _saveWebAsset(ActionRequest req, ActionResponse res, PortletConfig config, ActionForm form, User user) throws Exception {
		...
		ActivityLogger.logInfo(this.getClass(), "save HTMLpage action", "User " + user.getUserId() + " save page " + workingAsset.getTitle(), HostUtil.hostNameUtil(req, _getUser(req)));
	...
	public void _copyWebAsset(ActionRequest req, ActionResponse res, PortletConfig config, ActionForm form, User user) throws Exception {
		...
		ActivityLogger.logInfo(this.getClass(), "copy HTMLpage action", "User " + user.getUserId() + " copying page" + currentHTMLPage.getTitle(), HostUtil.hostNameUtil(req, _getUser(req)));
