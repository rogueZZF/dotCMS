...
//				}
	...
	public void _editWebAsset(ActionRequest req, ActionResponse res,
		...
		ActivityLogger.logInfo(this.getClass(), "Edit Template action", "User " + user.getUserId() + " edit template " + cf.getTitle(), HostUtil.hostNameUtil(req, _getUser(req)));
	...
	public void _saveWebAsset(ActionRequest req, ActionResponse res,
		...
		ActivityLogger.logInfo(this.getClass(), "Save Template action", "User " + user.getUserId() + " saving template" + newTemplate.getTitle(), HostUtil.hostNameUtil(req, _getUser(req)));
