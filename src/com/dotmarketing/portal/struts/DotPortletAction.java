...
public class DotPortletAction extends PortletAction {
	...
	throws Exception {
		...
		if (WebAssetFactory.archiveAsset(webAsset, user.getUserId())) {
			...
			ActivityLogger.logInfo(this.getClass(), "Delete WebAsset action", "User " + user.getUserId() + " deleting" + webAsset.getType()+" named "+webAsset.getTitle(), HostUtil.hostNameUtil(req, _getUser(req)));
		} else {
	...
	throws Exception {
		...
		if (InodeUtils.isSet(webAsset.getInode())) {
			...
			if (WebAssetFactory.unPublishAsset(webAsset, userId, parent)) {
				ActivityLogger.logInfo(this.getClass(), "Unpublish WebAsset action", "User " + user.getUserId() + " unpublishing" + webAsset.getType()+" named "+webAsset.getTitle(), HostUtil.hostNameUtil(req, _getUser(req)));
	...
	throws WebAssetException, Exception {
		try
		{
			...
			ActivityLogger.logInfo(this.getClass(), "Publish WebAsset action", "User " + user.getUserId() + " publishing" + webAsset.getType()+" named "+webAsset.getTitle(), HostUtil.hostNameUtil(req, _getUser(req)));
